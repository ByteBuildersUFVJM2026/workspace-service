...
-- FOR ROLE omitido: aplica ao usuário corrente (o usuário Flyway), independente do ambiente
...
-- Proteção adicional: nem o usuário admin pode alterar registros de auditoria
REVOKE DELETE, UPDATE ON TABLE auditoria_logs FROM ${admin_role};
